			...
			<div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
				...
				<form onSubmit={onSubmit} className="p-4 space-y-3 overflow-y-auto flex-1">
					...
					<div className="flex gap-2 pt-3">
						<button type="button" onClick={onClose} className="flex-1 px-3 py-2 text-xs border border-gray-200 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-colors">
							Cancel
						</button>
						<button type="submit" disabled={actionLoading} className="flex-1 flex items-center justify-center gap-1.5 bg-gradient-to-r from-primary-500 to-primary-600 text-white text-xs font-semibold py-2 rounded-lg transition-all disabled:from-gray-400 disabled:to-gray-400">
